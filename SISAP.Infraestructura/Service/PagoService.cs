   ...
   public class PagoService : IPagoService
    {
		...
		public PagoService(SISAPDBContext context)
		{
			_context = context;
		}
        ...
        public IEnumerable<Pago> GetPay(int? ClienteId, int pageSize, int skip, out int nroTotalRegistros)
        {
                ...
                var sql = (from p in _context.Pago
                           join c in _context.Cliente on p.ClienteId equals c.ClienteId into pc
                           from nc in pc.DefaultIfEmpty()
                           join cat in _context.Categoria on nc.CategoriaId equals cat.CategoriaId
                           join fa in _context.Facturacion on p.FacturacionId equals fa.FacturacionId
        ...
        {
            _context.Pago.Add(objPago);
            _context.SaveChanges();

            var data = _context.Facturacion.First(f => f.Annio == objPago.PeriodoAnnio && f.Mes == objPago.PeriodoMes && f.ClienteId == objPago.ClienteId);
